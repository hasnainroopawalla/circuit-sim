...
const SCHEMA_DATA_LATCH = {
  ...
  main: {
    ...
    wires: [
      ["chip.NOR.16.output.0/output.0", "chip.output.17/input.0"],
      ["chip.NOR.10.output.0/output.0", "chip.NOR.16.input.0/input.0"],
      ["chip.NOR.16.output.0/output.0", "chip.NOR.10.input.1/input.0"],
      ["chip.AND.2/output.0", "chip.NOR.10.input.0/input.0"],
      ["chip.AND.3/output.0", "chip.NOR.16.input.1/input.0"],
      ["chip.NOT.4/output.0", "chip.AND.3/input.1"],
      ["chip.input.1/output.0", "chip.AND.3/input.0"],
      ["chip.input.1/output.0", "chip.AND.2/input.1"],
      ["chip.input.0/output.0", "chip.NOT.4/input.0"],
...
describe("BlueprintHelper", () => {
  ...
  describe("blueprintToCircuit", () => {
    ...
    test.skip("returns the blueprint for a Data Latch", () => {
