...
export const LowerToolbar: React.FC<LowerToolbarProps> = (props) => {
  ...
  const blueprint1 = JSON.stringify({
    NAND: {
      inputs: [
        {
          id: "input-0",
          pin: "chip-0_input-pin-0",
        },
        {
          id: "input-1",
          pin: "chip-0_input-pin-1",
        },
      ],
      outputs: [
        {
          id: "output-0",
          pin: "chip-0_output-pin-0",
        },
      ],
      chips: [
        {
      ...
      wires: [
        ["chip-0_input-pin-1", "chip-0_input-pin-1"],
        ["chip-0_input-pin-0", "chip-0_input-pin-0"],
        ["chip-0_output-pin-0", "chip-1_input-pin-0"],
        ["chip-1_output-pin-0", "chip-0_output-pin-0"],
      ],
    },
    "NAND-NOT": {
      inputs: [
    ...
    main: {
      ...
      wires: [
        ["input-1_pin-0", "chip-0_input-pin-1"],
        ["input-0_pin-0", "chip-0_input-pin-0"],
        ["chip-0_output-pin-0", "output-0_pin-0"],
      ],
    },
  });
